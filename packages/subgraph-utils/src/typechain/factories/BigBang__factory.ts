...
import type { BigBang, BigBangInterface } from "../BigBang";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "computeOpenInterestMintable",
    outputs: [
      {
        internalType: "uint256",
        name: "",
...
export class BigBang__factory {
  static readonly abi = _abi;
  static createInterface(): BigBangInterface {
    return new Interface(_abi) as BigBangInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): BigBang {
    return new Contract(address, _abi, runner) as unknown as BigBang;
  }
}
