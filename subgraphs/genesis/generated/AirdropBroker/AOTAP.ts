...
export class AOTAP__attributesResultValue1Struct extends ethereum.Tuple {
  get expiry(): BigInt {
...
export class AOTAP__attributesResult {
  value0: Address;
  value1: AOTAP__attributesResultValue1Struct;

  constructor(value0: Address, value1: AOTAP__attributesResultValue1Struct) {
    this.value0 = value0;
    this.value1 = value1;
  }
...
export class AOTAP__optionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class AOTAP extends ethereum.SmartContract {
  static bind(address: Address): AOTAP {
    return new AOTAP("AOTAP", address);
  }
  ...
  attributes(_tokenId: BigInt): AOTAP__attributesResult {
    let result = super.call(
      "attributes",
    ...
    return new AOTAP__attributesResult(
      result[0].toAddress(),
      changetype<AOTAP__attributesResultValue1Struct>(result[1].toTuple())
    );
  }

  try_attributes(
    _tokenId: BigInt
  ): ethereum.CallResult<AOTAP__attributesResult> {
    let result = super.tryCall(
      "attributes",
      "attributes(uint256):(address,(uint128,uint128,uint256))",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      new AOTAP__attributesResult(
        value[0].toAddress(),
        changetype<AOTAP__attributesResultValue1Struct>(value[1].toTuple())
      )
    );
  }
  ...
  mintedAOTAP(): BigInt {
    let result = super.call("mintedAOTAP", "mintedAOTAP():(uint256)", []);

    return result[0].toBigInt();
  }

  try_mintedAOTAP(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("mintedAOTAP", "mintedAOTAP():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  options(param0: BigInt): AOTAP__optionsResult {
    let result = super.call(
      "options",
    ...
    return new AOTAP__optionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_options(param0: BigInt): ethereum.CallResult<AOTAP__optionsResult> {
    let result = super.tryCall(
      "options",
      "options(uint256):(uint128,uint128,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
