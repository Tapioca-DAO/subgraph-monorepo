...
export class LBP__getGradualWeightUpdateParamsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Array<BigInt>;
...
export class LBP__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class LBP__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class LBP__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class LBP__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class LBP__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class LBP__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class LBP extends ethereum.SmartContract {
  static bind(address: Address): LBP {
    return new LBP("LBP", address);
  }
  ...
  getGradualWeightUpdateParams(): LBP__getGradualWeightUpdateParamsResult {
    let result = super.call(
    ...
    return new LBP__getGradualWeightUpdateParamsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
  ...
  try_getGradualWeightUpdateParams(): ethereum.CallResult<
    LBP__getGradualWeightUpdateParamsResult
  > {
    let result = super.tryCall(
      "getGradualWeightUpdateParams",
      "getGradualWeightUpdateParams():(uint256,uint256,uint256[])",
    ...
    return ethereum.CallResult.fromValue(
      new LBP__getGradualWeightUpdateParamsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
  ...
  getPausedState(): LBP__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new LBP__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<LBP__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      []
  ...
  onExitPool(
    ...
    return new LBP__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<LBP__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
  ...
  onJoinPool(
    ...
    return new LBP__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<LBP__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
  ...
  onSwap(
    request: LBP__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    return new LBP__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<LBP__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LBP__queryExitResult(value[0].toBigInt(), value[1].toBigIntArray())
    );
  }
  ...
  queryJoin(
    ...
    return new LBP__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<LBP__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LBP__queryJoinResult(value[0].toBigInt(), value[1].toBigIntArray())
    );
  }
